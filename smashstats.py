...
embedColor = 00000000
moveError1 = "The move **%s** does not exist. Contact 1nder#5023 if you feel that this is a mistake!"
charError1 = "The character **%s** doesn't exist (Character names can't have spaces). Contact 1nder#5023 if you feel that this is a mistake!"
charError2 = "The character **%s** has no data yet. Contact 1nder#5023 if you feel that this is a mistake!"
hBoxError = "**%s** does not have a hitbox graphic. Contact 1nder#5023 if you feel that this is a mistake!"
...
async def on_message(req):
    ...
    if cmd == "viz" or cmd == "vis":
        ...
        return
    embed.set_footer(text="You can send comments, questions, and suggestions to 1nder#5023")
